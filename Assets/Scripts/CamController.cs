...
public class CamController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        transform.rotation = Quaternion.Euler(ymove*2.0f, xmove*2.0f, 0); // 이동량에 따라 카메라의 바라보는 방향을 조정합니다.
        Vector3 reverseDistance = new Vector3(0.0f, -1.0f, 0.2f); // 카메라가 바라보는 앞방향은 Z 축입니다. 이동량에 따른 Z 축방향의 벡터를 구합니다.
